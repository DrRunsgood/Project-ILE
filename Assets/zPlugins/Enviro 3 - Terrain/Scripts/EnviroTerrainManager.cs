...
{ 
    ...
    public float snow = 1.0f;
    public float wetness = 1.0f;
    public float puddles = 1.0f;
}
...
{ 
    ...
    public void CreateTextureArrays()
    {
        ...
        for(int i = 0; i < terrainLayer.Length; i++)
        {
            ...
            {
                albedoTextures.Add(Texture2D.blackTexture);
            }
...
//#endif 
    ...
    { 
        ...
        if(EnviroManager.instance != null && EnviroManager.instance.Effects != null)
        {
            ...
            Settings.rainIntensity = Mathf.Clamp01(Settings.rainIntensity);
        }
    ...
    private void UpdateShader()
    {
        ...
        if(Settings.snowEffects)
        {
            ...
            material.SetFloat("_Snow", 1);
        }
        else
        {
            material.DisableKeyword("_SNOW_ON");
            material.SetFloat("_Snow", 0);
        }
        ...
        if(Settings.antiTileSampling)
        {
            ...
            material.SetFloat("_STOCHASTIC", 1);
        }
        else
        {
            material.DisableKeyword("_STOCHASTIC_ON");
            material.SetFloat("_STOCHASTIC", 0);
        }
        ...
        { 
            ...
            material.SetFloat("_HEIGHTBLEND", 1);
            
        }
        else
        {
            material.DisableKeyword("_HEIGHTBLEND_ON");
            material.SetFloat("_HEIGHTBLEND", 0);
        }
        ...
        Vector4 snow0 = Vector4.zero;
        Vector4 snow1 = Vector4.zero;
        Vector4 snow2 = Vector4.zero;
        Vector4 wetness0 = Vector4.zero;
        Vector4 wetness1 = Vector4.zero;
        Vector4 wetness2 = Vector4.zero;
        Vector4 puddles0 = Vector4.zero;
        Vector4 puddles1 = Vector4.zero;
        Vector4 puddles2 = Vector4.zero;
        ...
        if(terrainLayer.Length > 0 && terrainLayer[0] != null)
        {
            ...
            if(layers.Count > 0 && layers[0] != null)
            {
               ...
               snow0.x = layers[0].snow;
               wetness0.x = layers[0].wetness;
               puddles0.x = layers[0].puddles;
        ...
        if(terrainLayer.Length > 1 && terrainLayer[1] != null)
        {
            ...
            if(layers.Count > 1 && layers[1] != null)
            {
               ...
               displacement0.y = layers[1].displacementModifier;
                snow0.y = layers[1].snow;
               wetness0.y = layers[1].wetness;
               puddles0.y = layers[1].puddles;
        ...
        if(terrainLayer.Length > 2 && terrainLayer[2] != null)
        {
            ...
            if(layers.Count > 2 && layers[2] != null)
            {
               ...
               displacement0.z = layers[2].displacementModifier;
                snow0.z = layers[2].snow;
               wetness0.z = layers[2].wetness;
               puddles0.z = layers[2].puddles;
        ...
        { 
            ...
            if(layers.Count > 3 && layers[3] != null)
            {
               ...
               displacement0.w = layers[3].displacementModifier;
                snow0.w = layers[3].snow;
               wetness0.w = layers[3].wetness;
               puddles0.w = layers[3].puddles;
        ...
        { 
            ...
            if(layers.Count > 4 && layers[4] != null)
            {
               ...
               displacement1.x = layers[4].displacementModifier;
                snow1.x = layers[4].snow;
               wetness1.x = layers[4].wetness;
               puddles1.x = layers[4].puddles;
            ...
            { 
               ...
               occlusion1.y = 1f-layers[5].occlusion;
                displacement1.y = layers[5].displacementModifier;
                 snow1.y = layers[5].snow;
               wetness1.y = layers[5].wetness;
               puddles1.y = layers[5].puddles;
        ...
        { 
            ...
            if(layers.Count > 6 && layers[6] != null)
            {
               ...
               occlusion1.z = 1f-layers[6].occlusion;
                ...
                snow1.z = layers[6].snow;
               wetness1.z = layers[6].wetness;
               puddles1.z = layers[6].puddles;
        ...
        { 
            ...
            if(layers.Count > 7 && layers[7] != null)
            {
               ...
               displacement1.w = layers[7].displacementModifier;
                snow1.w = layers[7].snow;
               wetness1.w = layers[7].wetness;
               puddles1.w = layers[7].puddles;
        ...
        { 
            ...
            if(layers.Count > 8 && layers[8] != null)
            {
               ...
               displacement2.x = layers[8].displacementModifier;
                snow2.x = layers[8].snow;
               wetness2.x = layers[8].wetness;
               puddles2.x = layers[8].puddles;
            ...
            if(layers.Count > 9 && layers[9] != null)
            {
               ...
               occlusion2.y = 1f-layers[9].occlusion;
                 displacement2.y = layers[9].displacementModifier;
                    snow2.y = layers[9].snow;
               wetness2.y = layers[9].wetness;
               puddles2.y = layers[9].puddles;
            ...
            normal2.z = layers[10].normalScale;
               occlusion2.z = 1f-layers[10].occlusion;
                displacement2.z = layers[10].displacementModifier;
                   snow2.z = layers[10].snow;
               wetness2.z = layers[10].wetness;
               puddles2.z = layers[10].puddles;
        ...
        { 
            ...
            if(layers.Count > 11 && layers[11] != null)
            {
               ...
               displacement2.w = layers[11].displacementModifier;
                  snow2.w = layers[11].snow;
               wetness2.w = layers[11].wetness;
               puddles2.w = layers[11].puddles;
        ...
        material.SetVector("_LayerSnow00", snow0);
        material.SetVector("_LayerSnow01", snow1);
        material.SetVector("_LayerSnow02", snow2);

        material.SetVector("_LayerWetness00", wetness0);
        material.SetVector("_LayerWetness01", wetness1);
        material.SetVector("_LayerWetness02", wetness2);

        material.SetVector("_LayerPuddle00", puddles0);
        material.SetVector("_LayerPuddle01", puddles1);
        material.SetVector("_LayerPuddle02", puddles2);
